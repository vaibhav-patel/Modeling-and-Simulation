...
ylim([0, 150]);
xlim([0, 700]);
legend('alpha = 0.005', 'alpha = 0.01', 'alpha = 0.05', 'alpha = 0.1', 'alpha = 0.5', 'alpha = 1','alpha = 0.005', 'alpha = 0.01', 'alpha = 0.05', 'alpha = 0.1', 'alpha = 0.5', 'alpha = 1');
